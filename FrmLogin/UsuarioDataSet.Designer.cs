...
namespace FrmLogin {
    ...
    public partial class UsuarioDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Tipo, string NombreUsuario, string Contraseña) {
...
namespace FrmLogin.UsuarioDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([ID] = @Original_ID) AND ([Tipo] = @Original" +
                "_Tipo) AND ([NombreUsuario] = @Original_NombreUsuario) AND ([Contraseña] = @Orig" +
                "inal_Contraseña))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Tipo], [NombreUsuario], [Contraseña]) VALUES (@Tip" +
                "o, @NombreUsuario, @Contraseña);\r\nSELECT ID, Tipo, NombreUsuario, Contraseña FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [Tipo] = @Tipo, [NombreUsuario] = @NombreUsuario, [Contraseña] = @Contraseña WHERE (([ID] = @Original_ID) AND ([Tipo] = @Original_Tipo) AND ([NombreUsuario] = @Original_NombreUsuario) AND ([Contraseña] = @Original_Contraseña));
SELECT ID, Tipo, NombreUsuario, Contraseña FROM Usuarios WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FrmLogin.Properties.Settings.Default.MarketaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Tipo, NombreUsuario, Contraseña FROM dbo.Usuarios";
        ...
        public virtual int Delete(int Original_ID, string Original_Tipo, string Original_NombreUsuario, string Original_Contraseña) {
        ...
        public virtual int Insert(string Tipo, string NombreUsuario, string Contraseña) {
            if ((Tipo == null)) {
        ...
        public virtual int Update(string Tipo, string NombreUsuario, string Contraseña, int Original_ID, string Original_Tipo, string Original_NombreUsuario, string Original_Contraseña, int ID) {
            if ((Tipo == null)) {
                throw new global::System.ArgumentNullException("Tipo");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Tipo, string NombreUsuario, string Contraseña, int Original_ID, string Original_Tipo, string Original_NombreUsuario, string Original_Contraseña) {
            return this.Update(Tipo, NombreUsuario, Contraseña, Original_ID, Original_Tipo, Original_NombreUsuario, Original_Contraseña, Original_ID);
        }
    }
